...
const { signup, login, getMe, changePassword, googleLogin, requestReset, checkResetStatus, resetPasswordWithToken, verifyEmail, skipVerification, resendVerification } = require('../controllers/authController');
