...
const VerifyEmail = () => {
  const { verifyEmail, resendVerification, skipVerification } = useContext(AuthContext);
        ...
        <div className="verify-glass-panel">
          ...
          <div className="auth-footer text-center" style={{marginTop: '30px', borderTop: '1px solid rgba(255,255,255,0.1)', paddingTop: '25px'}}>
            ...
            <div style={{marginTop: '20px'}}>
              ...
              >
                {skipLoading ? 'Please wait...' : 'Continue without verifying →'}
              </button>
            </div>
          </div>
        </div>
